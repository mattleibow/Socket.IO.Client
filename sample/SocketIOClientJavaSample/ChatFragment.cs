...
namespace SocketIOClientJavaSample
{
    public class ChatFragment : Fragment
    {
        ...
        public ChatFragment(string username, Socket socket)
        {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var chatWindow = view.FindViewById<ListView>(Resource.Id.chatWindow);
        ...
        private void AddMessage(string message, bool prepend = false)
        {
            if (prepend)
                chatItems.Insert(0, new ChatAdapter.ChatItem(message));
            else
                chatItems.Add(new ChatAdapter.ChatItem(message));
